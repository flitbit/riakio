...
function parseMultiPartResponse (body, res) {
	if (body && res) {
		...
		.map(parseHttpHeadersAndBody).filter(nonEmpty)
		.map(decodeMultipartPart);
		parts.sort(sortLastModifiedHeader);
...
Object.defineProperties(exports, {
	...
	appendPath: { value: appendPath, enumerable: true },

	padL: { value: padL, enumerable: true },

	extractBoundary: { value: extractBoundary, enumerable: true },

	filterHeaders: { value: filterHeaders, enumerable: true },

	makeLink: { value: makeLink, enumerable: true },

	makeLinks: { value: makeLinks, enumerable: true },

	linksToHeader: { value: linksToHeader, enumerable: true },

	prepareRequestOptions: { value: prepareRequestOptions, enumerable: true },

	prepareQueryPhase: { value: prepareQueryPhase, enumerable: true },
